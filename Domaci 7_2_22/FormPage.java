...
public class FormPage {
		...
		private WebDriver driver;
		  ...
		  public WebElement getCheckbox(String checkboxValue) {
			  return driver.findElement(By.xpath("//*[@type='checkbox'][@value='tech_blogs'+"+ checkboxValue +"']"));
...
//(read_books, online_courses, opensource, tech_cons, tech_blogs, via_delivery - jednu od ovde navedenih) 
//tog checkbox inputa
//getter koji hvata dugme treba da ceka da element postane klikabilan pre nego sto vrati element. Koristite
//waiter za ovaj slucaj.
